...
def make_video2(img_dir, output_dir, fps = 10.0):
    for label_name in os.listdir(img_dir):
        ...
        for video in os.listdir(video_dir):
            save_dir = os.path.join(output_dir, label_name, video+'.mp4')
...
if __name__ == '__main__':
    ...
    # 추론 결과를 동영상으로 만드는 경우
    results_dir = r'C:\Users\QBIC\Desktop\workspace\car_abnormal_driving\recognition\results\image'
    output_dir = r'C:\Users\QBIC\Desktop\workspace\car_abnormal_driving\recognition\results\video'
    tqdm.tqdm(make_video2(results_dir, output_dir))
