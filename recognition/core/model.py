...
class YOWO(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if cfg.WEIGHTS.BACKBONE_3D:# load pretrained weights on Kinetics-600 dataset
            ...
            pretrained_3d_backbone = torch.load(cfg.WEIGHTS.BACKBONE_3D, weights_only=True)
    ...
    def forward(self, input):
        ...
        x_2d = input[:, :, -1, :, :] # (if first frame of the clip: 0 or last frame of the clip: -1) that is read
