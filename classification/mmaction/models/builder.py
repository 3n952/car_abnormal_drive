...
def build_recognizer(cfg, train_cfg=None, test_cfg=None):
    ...
    ), "train_cfg specified in both outer field and model field"  # noqa: E501
    assert (
        cfg.get("test_cfg") is None or test_cfg is None
    ), "test_cfg specified in both outer field and model field "  # noqa: E501
...
def build_model(cfg, train_cfg=None, test_cfg=None):
    ...
    raise ValueError(
        f"{obj_type} is not registered in " "LOCALIZERS, RECOGNIZERS or DETECTORS"
    )
