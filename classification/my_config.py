# model settings
_base_ = ["configs/_base_/models/swin/swin_small.py", "configs/_base_/default_runtime.py"]
...
data_root = "./datasets"         # 데이터셋 경로
data_root_val = "./datasets"     # 데이터셋 경로
...
work_dir = "./work_dirs/pretrained_cls14.py"
