...
class BaseRecognizer(nn.Module, metaclass=ABCMeta):
    ...
    def __init__(
        self, backbone, cls_head=None, neck=None, train_cfg=None, test_cfg=None
    ):
        super().__init__()
        ...
        if backbone["type"].startswith("mmcls."):
            ...
            try:
                ...
                raise ImportError("Please install timm to use this " "backbone.")
    ...
    def init_weights(self):
        ...
        if self.backbone_from in ["mmcls", "mmaction2"]:
            ...
            raise NotImplementedError(
                "Unsupported backbone source " f"{self.backbone_from}!"
            )
    ...
    def extract_feat(self, imgs):
        ...
        """
        if hasattr(self.backbone, "features") and self.backbone_from == "torchvision":
